<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<header class="post-header">
      ...
      ?>
     <h3 class="it-info"> 
      <?php if($chassis) : ?> <div class="hope-car-sidebar-extra white-text">Chassis no: <?php echo $chassis ?></div> <?php endif; ?>
      <?php if($engine) : ?> <div class="hope-car-sidebar-extra white-text">Engine no: <?php echo $engine ?></div> <?php endif; ?>
    </h3>
